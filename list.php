...
<div class="mdui-row">
	<ul class="mdui-list">
		<li class="mdui-list-item th">
		  <div class="mdui-col-xs-12 mdui-col-sm-7 item-sort" data-sort="name" data-order="downward">文件 <i class="mdui-icon material-icons icon-sort">expand_more</i></div>
		  <div class="mdui-col-sm-3 mdui-text-right item-sort" data-sort="date" data-order="downward">修改时间 <i class="mdui-icon material-icons icon-sort">expand_more</i></div>
		  <div class="mdui-col-sm-2 mdui-text-right item-sort" data-sort="size" data-order="downward">大小 <i class="mdui-icon material-icons icon-sort">expand_more</i></div>
		</li>
		<?php if($path != '/'):?>
...
$(function(){
	...
	$('.item-sort').on('click', function () {
        ...
        $(this).attr("data-order", sort_order_to);
		$(this).find('.icon-sort').text("expand_" + sort_order_to);
    });
